...
<%@page import="com.gmail.persiopg.entidades.TbLanches"%>
<%@page import="com.gmail.persiopg.Dao.DaoLanches"%>
<%@page import="java.util.List"%>
<%@page import="com.gmail.persiopg.view.ServletLanches"%>
...
<html>
    ...
    <body>
        ...
        <% 
            ServletLanches sl = new ServletLanches();
            List<TbLanches> getList = sl.listaLanches();
        %>                       
